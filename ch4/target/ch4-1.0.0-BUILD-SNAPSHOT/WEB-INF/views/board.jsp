...
<script>
    $(document).ready(function (){ //main()
        ...
        $('#writeBtn').on("click", function () {
            let form=$('#form');
            form.attr("action", "<c:url value='/board/write'/>"); //action을 취하고
            form.attr("method", "post"); //메서드는 post//
            form.submit();
        });
        $('#modifyBtn').on("click", function () {
            ...
            form.attr("action", "<c:url value='/board/modify'/>"); //action을 취하고
            form.attr("method", "post"); //메서드는 post//
            form.submit();
        });
        $('#removeBtn').on("click", function () {
            ...
            let form=$('#form');
            form.attr("action", "<c:url value='/board/remove'/>?page=${page}&pageSize=${pageSize}"); //action을 취하고
            form.attr("method", "post"); //메서드는 post//
            form.submit();
        });
    });
